...
class DeliveryManDetailsScreen extends StatelessWidget {
  ...
  final int index;
  DeliveryManDetailsScreen({@required this.deliveryMan, @required this.index});
              ...
              Row(children: [
                ...
                AmountCardWidget(
                  ...
                  value: PriceConverter.convertPrice(
                      dmController.deliveryManList[index].cashInHands),
              ...
              CustomButton(
                onPressed: () {
                  Get.dialog(ConfirmationDialog(
                    icon: Images.warning,
                    description: 'do_you_want_to_reset_collected_cash'.tr,
                    onYesPressed: () =>
                        dmController.resetCollectedCash(deliveryMan.id),
                  ));
                },
                buttonText: 'reset_collected_cash'.tr,
